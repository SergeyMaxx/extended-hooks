...
const MemoExample = () => {
  return (
    <>
      ...
      <CardWrapper>
        <i className="bi bi-lightbulb"/> Если функциональный
      ...
      <CardWrapper>
        ...
        <CardWrapper>
          <i className="bi bi-lightbulb"/>
          Если функция для сверки не задана, то выполняется поверхностная сверка по{' '}
          <Link
            to={{pathname: 'https://github.com/facebook/react/blob/v16.8.6/packages/shared/shallowEqual.js'}}
            target="_blank"
          >
